 ...
 */
export const documentsCreateDocumentUrl400Schema = errorInfoSchema.describe(
 ...
 */
export const documentsCreateDocumentUrl401Schema = errorInfoSchema.describe(
  'error information for non http status 200',
) as unknown as ToZod<DocumentsCreateDocumentUrl401>

export const documentsCreateDocumentUrlMutationRequestSchema =
