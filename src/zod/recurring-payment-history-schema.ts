...
export const recurringPaymentHistorySchema = z.object({
  ...
  "Status": z.string().describe("SUCCESSFUL , PENDINGFORPROCESSING , DEBTAUTOBILLING , LOSTDEBT , PAYBYOTHERE  , ONHOLD , UNKNOWN + (error Code)").nullable().nullish()
