 ...
 */
export const extGetRecurringPaymentHistoryRspSchema: z.ZodObject<import("/home/m/dev/git/cardcom-ts-sdk/node_modules/@kubb/plugin-zod/dist/utils/v4").ZodShape<ExtGetRecurringPaymentHistoryRsp>, "passthrough"> = z
  .object({
