...
export const tokenInfoSchema = z.object({
  ...
  "CardOwnerIdentityNumber": z.string().describe("card holder identity number").optional()
      }).describe("Create token result, You need to save all of the information in the database next to the account, it will be used in the Token charge process") as unknown as ToZod<TokenInfo>