...
export const terminalInfoSchema = z.object({
  ...
  "BankBranchCode": z.string().describe("Bank branch code -  - get list of bank branches from https://secure.cardcom.solutions/api/v11/CompanyOperations/GetBanksBranches by bank number").nullable().nullish(),
