...
export const documentBaseSchema = z.object({
      get DocumentTypeToCreate(){
                  return documentToCreateSchema.default("Auto").describe("Document type to create,  default = 0, will automatically update from admin panel configuration").nullable().nullish()
                },
