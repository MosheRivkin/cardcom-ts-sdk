...
export const productsSchema = z.object({
  ...
  "TotalLineCost": z.number().default(0).describe("Recommended, if the Quantity contains decimal point send the total line cost to prevent round errors").nullable().nullish(),
