...
export const dataSchema = z.object({
  ...
  get ReportCode(){
                  return reportCodesSchema.describe("Report Code ,1 - New Credit Card, 2 - Card was canceled – no new number issued, 3 - CHB, 4 - Card was canceled – no new number issued , 5 - Card Unfreeze").optional()
                },
