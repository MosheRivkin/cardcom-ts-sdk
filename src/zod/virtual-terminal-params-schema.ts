...
export const virtualTerminalParamsSchema = z.object({
  ...
  "ChargeOnSwipe": z.boolean().default(false).describe("When using Credit Card reader , will the \"commit\" button be press after the merchent swipe the credit card").nullable().nullish()
