...
export const changeStatusForHistoryRecurringToIrrevocableReqestSchema: z.ZodObject<import("@kubb/plugin-zod/utils").ZodShape<ChangeStatusForHistoryRecurringToIrrevocableReqest>> = z.object({
