 ...
 */
export const transactionsGetTransactionInfoById400Schema = errorInfoSchema.describe(
 ...
 */
export const transactionsGetTransactionInfoById401Schema = errorInfoSchema.describe(
  'error information for non http status 200',
) as unknown as ToZod<TransactionsGetTransactionInfoById401>

export const transactionsGetTransactionInfoByIdMutationRequestSchema =
  transactionInfoRequestSchema.nullable() as unknown as ToZod<TransactionsGetTransactionInfoByIdMutationRequest>

export const transactionsGetTransactionInfoByIdMutationResponseSchema =
