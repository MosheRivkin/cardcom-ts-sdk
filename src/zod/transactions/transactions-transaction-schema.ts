import type { TransactionsTransaction200, TransactionsTransaction400, TransactionsTransaction401, TransactionsTransactionMutationRequest, TransactionsTransactionMutationResponse } from "../../types/TransactionsTransaction.ts";
 ...
 */
export const transactionsTransaction400Schema = errorInfoSchema.describe("error information for non http status 200") as unknown as ToZod<TransactionsTransaction400>

/**
 * @description Invalid username
 */
export const transactionsTransaction401Schema = errorInfoSchema.describe("error information for non http status 200") as unknown as ToZod<TransactionsTransaction401>
