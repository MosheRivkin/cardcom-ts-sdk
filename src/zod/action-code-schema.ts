...
export const actionCodeSchema: z.ZodType<import("src/index").ActionCodeEnum, unknown, z.core.$ZodTypeInternals<import("src/index").ActionCodeEnum, unknown>> = z.enum([
  'NoActionCode',
  'Purchase_1',
  'Return_6',
  'FeeCharge_10',
