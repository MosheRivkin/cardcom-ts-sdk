 ...
 */
export const financialCreditCardTransactions400Schema = errorInfoSchema.describe(
 ...
 */
export const financialCreditCardTransactions401Schema = errorInfoSchema.describe(
  'error information for non http status 200',
