 ...
 */
export const recuringPaymentsGetMuhlafimByDate200Schema = extGetListOfFilesRspSchema.describe(
 ...
 */
export const recuringPaymentsGetMuhlafimByDate400Schema = errorInfoSchema.describe(
 ...
 */
export const recuringPaymentsGetMuhlafimByDate401Schema = errorInfoSchema.describe(
  'error information for non http status 200',
...
export const recuringPaymentsGetMuhlafimByDateMutationResponseSchema =
