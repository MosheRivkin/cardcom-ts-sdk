 ...
 */
export const recuringPaymentsGetRecurringPayment200Schema = extGetRecurringPaymentRspSchema.describe(
 ...
 */
export const recuringPaymentsGetRecurringPayment400Schema = errorInfoSchema.describe(
 ...
 */
export const recuringPaymentsGetRecurringPayment401Schema = errorInfoSchema.describe(
  'error information for non http status 200',
...
export const recuringPaymentsGetRecurringPaymentQueryResponseSchema =
