 ...
 */
export const recuringPaymentsIsBankNumberValid200Schema = extIsBankNumberValidRspSchema.describe(
  'Is Bank valid',
 ...
 */
export const recuringPaymentsIsBankNumberValid400Schema = errorInfoSchema.describe(
 ...
 */
export const recuringPaymentsIsBankNumberValid401Schema = errorInfoSchema.describe(
  'error information for non http status 200',
