 ...
 */
export const tapTransactionsProcessTransaction400Schema = errorInfoSchema.describe(
 ...
 */
export const tapTransactionsProcessTransaction401Schema = errorInfoSchema.describe(
  'error information for non http status 200',
...
export const tapTransactionsProcessTransactionMutationResponseSchema =
