 ...
 */
export const createLowProfileSchema = z.object({
  ...
  "ReturnValue": z.string().max(250).describe("A string of data to save on the transaction, usually send your unique order Id, you will get it back in the WebHook URL").nullable().nullish(),
  ...
  "Language": z.string().max(2).default("he").describe("Page Language - he,en,ru,sp (https://cardcomapinametovalue.zendesk.com/hc/he/articles/27007768777234-שפות-לדף-פרופיל-נמוך-Language)").nullable().nullish(),
