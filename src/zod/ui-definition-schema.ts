 ...
 */
export const uiDefinitionSchema: z.ZodObject<import("@kubb/plugin-zod/utils").ZodShape<UIDefinition>> = z
  .object({
    ...
    CSSUrl: z
      .string()
      .max(250)
      .describe('Full URL address of CSS file. it will be injected to page, required CardCom premition (http(s)://site.com/file.css)')
      .nullable()
      .nullish(),
    get CustomFields() {
