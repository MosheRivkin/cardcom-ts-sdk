...
export const advancedDocumentDefinitionSchema: z.ZodObject<import("/home/m/dev/git/cardcom-ts-sdk/node_modules/@kubb/plugin-zod/dist/utils/v4").ZodShape<AdvancedDocumentDefinition>, "passthrough"> = z
  .object({
    ...
    IsLoadInfoFromAccountID: z
      .boolean()
      .default(false)
      .describe('If AccountID is passed, CardCom system will update the document information ( To ,HP_TZ, Email ...) from existing accounts information')
      .nullable()
      .nullish(),
  })
