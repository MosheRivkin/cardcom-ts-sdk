 ...
 */
export const companyOperationsCloseCompany400Schema = errorInfoSchema.describe(
 ...
 */
export const companyOperationsCloseCompany401Schema = errorInfoSchema.describe(
  'error information for non http status 200',
