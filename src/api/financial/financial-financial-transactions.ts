...
export async function financialFinancialTransactions(
  ...
  const res: import("@kubb/plugin-client/clients/axios").ResponseConfig<import("src/index").FinancialTransactionsResp> = await request<
    FinancialFinancialTransactionsMutationResponse,
