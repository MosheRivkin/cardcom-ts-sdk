...
export function companyOperations() {
  return { companyOperationsGetCompanyStatus, companyOperationsAddDocumentToCompany, companyOperationsValidateCompanyCreation, companyOperationsNewCompany, companyOperationsCloseCompany, companyOperationsReOpenCompany, companyOperationsGetCities, companyOperationsGetStreets, companyOperationsGetCountries, companyOperationsGetBanks, companyOperationsGetBanksBranches, companyOperationsGetMainMcCs, companyOperationsGetSubMcCs, companyOperationsMeagedAddCompany, companyOperationsMeagedGetCompanyInfo }
}