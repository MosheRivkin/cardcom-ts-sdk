...
): Promise<{ SapakStatus?: import("src/index").SapakStatus | undefined; SapakNumber?: number | null | undefined; IsDevError?: boolean | undefined; IsInputError?: boolean | undefined; ResponseCode?: number | undefined; Description?: string | null | undefined; InputErrorPropName?: string | null | undefined; }> {
  const { client: request = fetch, ...requestConfig } = config

  const requestData: { IsValidationOnly: boolean; SupplierUserName: string; Secret: string; CompnayInfo: { BusinessRegistrationNumber: number; NameLegalCorporation: string; NameLegalCorporationEng: string; Email: string; PhoneNumber1: string; ZipCode: string; CityCode: number; StreetCode: number; AdvertisingSapakName?: string | null | undefined; AdvertisingSapakEngName?: string | null | undefined; PhoneNumber2?: string | null | undefined; HouseNumber?: string | null | undefined; }; PeopleInfo: { RelationType: import("src/index").Relations; IdentityNumber: number; IdentityIssueDate_DDMMYYYY: string; IdentityExpireDate_DDMMYYYY: string; BirthDate_DDMMYYYY: string; Gender: import("src/index").Gender2; FirstName: string; LastName: string; StreetCode: number; CityCode: number; PhoneNumber1: string; ResedentialCountryCode?: string | null | undefined; ZipCode?: string | null | undefined; HouseNumber?: string | null | undefined; PhoneNumber2?: string | null | undefined; Fax?: string | null | undefined; Email?: string | null | undefined; }[]; KycInfo: { Mcc: number; MaxNumberOfPayments: number; ElectronicCommerceUrl?: string[] | null | undefined; }; } | null = companyOperationsMeagedAddCompanyMutationRequestSchema.parse(data)
  const res: import("@kubb/plugin-client/clients/axios").ResponseConfig<import("src/index").OpenMeagedResponse> = await request<CompanyOperationsMeagedAddCompanyMutationResponse, ResponseErrorConfig<Error>, CompanyOperationsMeagedAddCompanyMutationRequest>({
    method: 'POST',
