...
export async function recuringPaymentsGetRecurringPaymentHistory(
  ...
  const requestData: { apiUserName?: string | null | undefined; apiPassword?: string | null | undefined; RowId?: number | null | undefined; AccountId?: number | null | undefined; FromDate?: string | null | undefined; ToDate?: string | null | undefined; FilterBy?: (import("/home/m/dev/git/cardcom-ts-sdk/src/index").FilterBy | null) | undefined; } | null = recuringPaymentsGetRecurringPaymentHistoryQueryRequestSchema.parse(data)
  const res: import("/home/m/dev/git/cardcom-ts-sdk/node_modules/@kubb/plugin-client/dist/clients/axios").ResponseConfig<import("/home/m/dev/git/cardcom-ts-sdk/src/index").ExtGetRecurringPaymentHistoryRsp> = await request<
    RecuringPaymentsGetRecurringPaymentHistoryQueryResponse,
