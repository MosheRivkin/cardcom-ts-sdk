...
export function documents() {
  return { documentsCreateDocument, documentsCancelDoc, documentsSendAllDocumentsToEmail, documentsGetReport, documentsCrossDocument, documentsCreateTaxInvoice, documentsCreateDocumentUrl }
}