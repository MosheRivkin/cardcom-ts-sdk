...
export async function documentsCreateDocument(
...
): Promise<{ ResponseCode?: number | undefined; Description?: string | undefined; DocumentType?: import("src/index").DocumentType | undefined; DocumentNumber?: number | undefined; AccountId?: number | undefined; ForeignAccountNumber?: string | null | undefined; SiteUniqueId?: string | null | undefined; DocumentUrl?: string | null | undefined; }> {
  ...
  const res: import("@kubb/plugin-client/clients/axios").ResponseConfig<import("src/index").DocumentInfo> = await request<
    DocumentsCreateDocumentMutationResponse,
